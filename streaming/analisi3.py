...
windowed_df = parsed_df \
	...
	.groupBy(window("timestamp", kafka_parameters["WINDOW_DURATION"])) \
	.count()
windowed_df = windowed_df.withColumnRenamed("count", "n_packets")
